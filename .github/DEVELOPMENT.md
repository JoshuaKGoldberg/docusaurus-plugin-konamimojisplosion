...
```shell
git clone https://github.com/<your-name-here>/docusaurus-plugin-konamimojisplosion
cd docusaurus-plugin-konamimojisplosion
pnpm install
```
...
```shell
node ../docusaurus-plugin-konamimojisplosion/lib/hydrate/index.js -- description "Hooray, trying things out locally."
```
